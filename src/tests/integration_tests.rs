...
mod integration_tests {
    use helix::{parse, validate, ast_to_config, AgentConfig};
    use helix::compiler::Compiler;
    use helix::compiler::optimizer::OptimizationLevel;
    use helix::compiler::{serializer::BinarySerializer, loader::BinaryLoader};
    use helix::codegen::{StringPool, Metadata, SymbolTable, ConstantPool};
    ...
    fn test_config_merging() {
        use helix::{HelixConfig, HelixLoader};
    ...
    fn test_optimization_string_deduplication() {
        use helix::{HelixIR};
        use helix::compiler::optimizer::{Optimizer, OptimizationLevel};
        ...
        symbol_table
            ...
            .insert(
                ...
                CrewSymbol {
                    ...
                    name_idx: 4,
                    agent_ids: vec![1],
                    process_type: helix::codegen::ProcessTypeIR::Sequential,
                    manager_id: None,
                },
            );
        let mut ir = HelixIR {
    ...
    fn test_binary_roundtrip_preserves_data() {
        ...
        use helix::compiler::serializer::BinarySerializer;
        let mut string_pool = StringPool::new();
    ...
    fn test_crew_with_hierarchical_structure() {
        ...
        assert_eq!(crew.process_type, helix::types::ProcessType::Hierarchical);
