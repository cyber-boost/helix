...
impl<W: Write + Seek> HlxbWriter<W> {
    ...
    pub fn write_agents(&mut self, agents: &HashMap<String, crate::types::AgentConfig>) -> Result<(), HlxError> {
        self.write_section(SectionType::Agents, agents)
    }

    pub fn write_workflows(&mut self, workflows: &HashMap<String, crate::types::WorkflowConfig>) -> Result<(), HlxError> {
        self.write_section(SectionType::Workflows, workflows)
    }

    pub fn write_crews(&mut self, crews: &HashMap<String, crate::types::CrewConfig>) -> Result<(), HlxError> {
        self.write_section(SectionType::Crews, crews)
    }

    pub fn write_contexts(&mut self, contexts: &HashMap<String, crate::types::ContextConfig>) -> Result<(), HlxError> {
...
impl<R: Read + Seek> HlxbReader<R> {
    ...
    pub fn read_config(&mut self) -> Result<crate::types::HelixConfig, HlxError> {
        #[cfg(not(feature = "bincode"))]
        ...
        #[cfg(feature = "bincode")]
        {
            ...
            let mut config = crate::types::HelixConfig::default();
            ...
            for _ in 0..header.section_count {
                ...
                match section_header.section_type {
                    SectionType::Agents => {
                        let agents: HashMap<String, crate::types::AgentConfig> = deserialize(&section_data)
                    ...
                    SectionType::Workflows => {
                        let workflows: HashMap<String, crate::types::WorkflowConfig> = deserialize(&section_data)
                            .map_err(|e| HlxError::deserialization_error(
                    ...
                    SectionType::Crews => {
                        let crews: HashMap<String, crate::types::CrewConfig> = deserialize(&section_data)
                            .map_err(|e| HlxError::deserialization_error(
                    ...
                    SectionType::Contexts => {
                        let contexts: HashMap<String, crate::types::ContextConfig> = deserialize(&section_data)
                            .map_err(|e| HlxError::deserialization_error(
...
impl HlxbConfigHandler {
    ...
    pub fn write_helix_config<W: Write + Seek>(config: &crate::types::HelixConfig, writer: &mut W) -> Result<(), HlxError> {
    ...
    pub fn read_helix_config<R: Read + Seek>(reader: &mut R) -> Result<crate::types::HelixConfig, HlxError> {
