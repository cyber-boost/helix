use crate::codegen::{HelixIR, Instruction};
    ...
    fn remap_instruction_strings(
        ...
        match instruction {
            Instruction::SetProperty { key, value, .. } => {
                ...
                if let crate::codegen::ConstantValue::String(idx) = value {
...
mod tests {
    use super::*;
    use crate::codegen::{StringPool, SymbolTable, Metadata, ConstantPool};
    #[test]
